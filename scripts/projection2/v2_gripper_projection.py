...
class DepthReader:
    ...
    def depth_callback(self, depth_msg):
        ...
        scale_factor1 = depth_rect1 / depth_in_meters if depth_in_meters > 0 else 1.0
        scale_factor2 = depth_rect2 / depth_in_meters if depth_in_meters > 0 else 1.0

        # Calculate new dimensions for purple rectangles
        ...
        # Scale the orange rectangles to create purple rectangles
        rect1_top_left_purple, rect1_bottom_right_purple = scale_rectangle(
            rect1_top_left, rect1_bottom_right, scale_factor1
        )
        rect2_top_left_purple, rect2_bottom_right_purple = scale_rectangle(
            rect2_top_left, rect2_bottom_right, scale_factor2
        )
